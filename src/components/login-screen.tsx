...
const themes = [
  {
    ...
    formClass:
      'bg-[#0a1525]/40 backdrop-blur-xl border border-[#3a6a9c]/30 rounded-lg p-6',
    ...
    tabClass:
      'data-[state=active]:bg-[#1a2e4c]/70 data-[state=active]:text-[#a3e4ff]',
    alertClass: 'bg-[#1a2e4c]/70 border-[#3a6a9c]/50',
    linkClass:
      'text-[#a3e4ff] hover:text-[#7bc9ff] underline-offset-4 hover:underline',
  },
  {
    id: 'space',
    name: 'Space',
    backgroundImage: '/backgrounds/bgsddm2.png',
    fontClass: 'font-sans',
    timeClass: 'text-white text-6xl font-light',
    dateClass: 'text-white/80',
    formClass:
      'bg-[#1a2e4c]/30 backdrop-blur-xl rounded-xl border border-white/10 p-6',
    ...
    >
      ...
      <AnimatePresence mode="wait">
        ...
        >
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center text-sm">
                      <button
                        ...
                        className={currentTheme.linkClass}
                      >
                        Create account
                      </button>
                      <button
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-white/70 mb-6 text-sm">
                      ...
                      <span className="text-white">{resetEmail}</span>. Please
          ...
          >
            <button
              className={`p-2 rounded-md ${currentTheme.systemButtonClass}`}
